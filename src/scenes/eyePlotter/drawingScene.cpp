...
void drawingScene::setup(){
	...
	//toggle drawing
	bDrawing = false;
	pause.setup("recording", "paused", bDrawing, 10, 50, 225, 110);
	//pause.setDisplayFont(&bigFont);
	
	//buttons that should be shown when drawing
	nextLetter.setup("next letter", 10, 175, 225, 90);	
	nextLetter.setDisplayFont(&bigFont);
	nextStroke.setup("next stroke", 10, 275, 225, 90);
	nextStroke.setDisplayFont(&bigFont);
	undoPoint.setup("undo point", 10, 375, 225, 90);
	undoPoint.setDisplayFont(&bigFont);
	undo.setup("undo stroke", 10, 475, 225, 90);
	undo.setDisplayFont(&bigFont);
	showGrid.setup("grid on", "grid off", false, 10, 200, 225, 110);
	//showGrid.setDisplayFont(&bigFont);
